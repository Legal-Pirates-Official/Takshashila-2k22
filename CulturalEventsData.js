    ...
    data: [
      {
        ...
        rules: [
          {
            Prelims: [
              "The google forms have to be filled and the video can be uploaded through the same.",
              "Visit our website link www.cittakshashila.org for uploading. ",
          ...
          },
          {
            Finals: [
              ...
              "Marks will be allotted based on the Performance, Team coordination and Costume selection. ",
        ...
        registration: [
          ...
          "The entry fee is Rs.220 per head.",
          ...
          "Participants are requested to make their presence inside the college premises before 2 pm.",
          "The team-head should register for the event, on behalf of the team."
        ],
        contact: [
          { name: "Kavya", number: "+91 6374253694" },
      ...
      },
      {
        name: "Musical night",
        description:
          "Let the music levitate your soul. The stage is set ablaze with melodies to vibearound..",
        registration: [
          "College ID card is mandatory",
          "It comes under general registration"
        ],
        contact: [
    ...
    data: [
      {
        ...
        rules: [
          {
            "": [
              "Usage of metronomes will not be permitted.",
          ...
          {
            Prelims: [
              "Each participant will be given 1 to 2 minutes including setup time.",
          ...
          {
            Finals: [
              "Finals will take place once the prelims results are announced..",
              "Time limit is 3 to 4 minutes.",
        ...
        rules: [
          {
            Prelims: [
              ...
              "Judge's and organizer's decisions will be final.",
              "5 students will be selected for the final round."
            ]
          },
          {
            Finals: [
        ...
        rules: [
          ...
          },
          {
            Finals: [
              ...
              "Other participants cannot interrupt the current speaker..",
      ...
      },
      {
        ...
        rules: [
          {
            "": [
              "A random team of 2 to 4 members will be made with the participants.",
      ...
      },
      {
        ...
        rules: [
          {
            "": [
              ...
              "Exchanging thoughts should be only in English (usage of other languages is not allowed) ",
              ...
              "Usage of abusive words is not permitted.",
              "Participants are not allowed to cross talk.",
              "Abusing your opponent personally is strictly prohibited.",
              "Judges’ and organizers’ decisions will be final."
            ]
          }
        ],
        contact: [
          { name: "Sanjana", number: "7397314380" },
          { name: "Gunalan", number: "8610822039" }
        ],
        link: "https://www.google.com",
        image: "itsdebatable"
      },
      {
        ...
        rules: [
          {
            "": [
              "Participants are requested to send their short films to the google drive..",
              "Submissions should be sent on or before the 18th MAY 2022.",
              "Shortlisted films will be screened on the day of the event.",
              "Poster and teaser will be required for short films ",
        ...
        contact: [
          { name: "Supriya", number: "9390041226" },
          { name: "Chandru", number: "9962737406" }
        ],
        link: "https://www.google.com",
        image: "24frames"
      },
      {
        name: "Act-O-Mania",
        description:
          "Silence is better than a thousand words. In this utopia of expressions and gestures let your emotions come to life and your actions reign over the spotlight.. It's not a youtube short or reel. Let the beauty of your short film sink through our minds. Open our eyes , oh director",
        registration: [
          "College ID is mandatory.",
          "The event comes under general registration.",
          "The team-head should register for the event, on behalf of the team."
        ...
        rules: [
          {
            "": [
              "Each team can have a maximum of 4 to 10 members.",
              "Duration of performing the act is limited from 3 to 6 minutes for each team.",
              "Exceeding the specified time is strictly prohibited.",
              "Teams selected from the group stage will be allowed to perform on the informal stage.",
      ...
      },
      {
        ...
        contact: [
          { name: "Ganapathi", number: "9344267027" },
          { name: "Abhirami", number: "7358417463" }
        ],
        link: "https://www.google.com",
        image: "solodance"
      },
      {
        ...
        contact: [
          { name: "Manasa", number: "9490509472" },
          { name: "Dharahash", number: "8072055008" }
        ],
        link: "https://www.google.com",
        image: "duals"
      },
        ...
        rules: [
          {
            "": [
              ...
              "Team will be a time of 3 to 4 minutes gto inspect the crime scene.",
              "A video of suspects statements will be played to the teams.",
              "Team must discuss the case within the specified time.",
              "Gadgets will not be allowed within premises.",
              "For each hint asked by the team accountable points will be deducted as per jury team.",
              "Points shall be awarded based on different criteria and shall be informed beforehand."
            ]
          }
        ],
        contact: [
          { name: "Sai Teja", number: "9390165105" },
          { name: "Vishalakshi Janani", number: "8838290451" }
        ],
        link: "https://www.google.com",
      ...
      },
      {
        ...
        contact: [
          ...
          { name: "Priyadharshini", number: "8870528203" }
        ],
        link: "https://www.google.com",
        image: "memecraft"
      },
      {
        ...
        rules: [
          {
            "": [
              ...
              "Upload your digital art by visiting our website link www.cittakshashila.org",
        ...
        contact: [
          { name: "Poorvaja", number: "9789934951" },
          { name: "Jansi Victoria", number: "7904060230" }
        ],
        link: "https://www.google.com",
        image: "stylusstrokes"
      },
      {
        name: "image.jpeg",
        description: "Focus,capture and portray your essence of creativity.Set your focus and lens your best!!.", 
        registration: [
          "College ID is mandatory.",
          "The event comes under general registration.",
          ],
      ...
      {
        name: "Plush",
        description: "Walking tall with your brilliant, sharp outfit brings out the beauty of this event!Let the vigor in your strides make everyone's jaw drop. Plush is an event of confidence andelegance.",
        registration: [
        "College ID is mandatory.",
        "The event comes under general registration.",
        "The team-head should register for the event, on behalf of the team.",
...
"Only a single non-edited video should be submitted through our website link",
"www.cittakshashila.org ",
...
"Music for the event can be brought by teams themselves."
    ...
    contact:[
      ...
      {
        name: "Framespot",
      description: "Be the person who feels the frame and finds a story. Hey Artist, Find the frame and get flooded with fame.",
      registration: [
      "College ID is mandatory.",
      "The event comes under general registration."
            ],
...
"The judge's decision is final."
          ...
          "round 2": ["Difficulty level will be increased for the round.",
      ...
      }, 
      {
        ...
        description: "Journal through the wild and craft a world class report. Report creativity is the best policy.",
        registration: [
        "College ID is mandatory.",
        "The event comes under general registration."
      ],
      ...
      {name: "Ok-Doodle",
      description: "Sketch down your messy creativity .Something sketchy is better than anempty canvas. Sketch your way and doodle your destiny.",
      registration: [
      "College ID is mandatory.",
      "The event comes under general registration."
      ],
      ...
      {name: "Wordsmith",
      description: "Pen down your superiority through creativity . The words shall forecast your victory. Explore beyond your wits and sprinkle them , like toppings on a cake. Here is your chance to unleash the writer within you..",
      registration: [
      "College ID is mandatory.",
      "The event comes under general registration."],
      rules: [{
        "round 1": [" Only English language must be used.",
        ...
        "round 2": ["Only English language must be used.",
        "Topic will be given on spot.",
        "Individual participation.",
        "Time limit: 30 minutes",
        " Decision of the jury will be final."]
      ...
      {name: "On-Air",description: "If friendly banter and casual chit chat is your forte, and you have been wanting to scream out your opinions to the world, here's the chance of your life..",
      registration: [
      "College ID is mandatory.",
      "The event comes under general registration."
      ],
      ...
      rules: [{
        'round 1': ["Duration 2-4 mins per participant..",
        ...
        'round 2': ["Duration 3 minutes per participant.",
      ...
      {name: "Cypher",
      description: "As the beat drops, Pull up your sleeves, get on the dance floor, toggle yourmoves to the dynamic stomps of the upbeat songs ",
      registration: [
      "College ID is mandatory.",
      "The event comes under general registration."
      ],
      ...
      {
        name: "Graphite-ty",
description: "Let the graphite stain the A3s and let your creativity take control , sketch your way to victory",
registration: [
"College ID is mandatory.",
"The event comes under general registration."
],
...
contact:[
  ...
  image:"tklogo"
      ...
      {
        name: "Comic quiz",
description: "What's your superpower or are you a geek hero enough to see through questions and settle yourself for a perfect score?.",
registration: [
"College ID is mandatory.",
"The event comes under general registration."],
...
contact:[
  ...
  image:"tklogo"
      ...
      {
        name: "Shipwreck",
description: "The captain is in a complete dilemma , but your charms and wits could be your life jacket.",
registration: [
"College ID is mandatory.",
"The event comes under general registration."
],
