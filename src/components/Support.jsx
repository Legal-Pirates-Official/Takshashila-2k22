      ...
      <SupportSection className={className}>
        ...
        <div className="sm-icons container pb-3">
          ...
          <div className=" d-flex flex-row w-100 justify-content-start">
            <a className="m-2 ms-0 text-white" href="https://m.facebook.com/CIT-Takshashila-106831860821647">
              <FaFacebook size={25} />
            </a>
            <a className="m-2 text-white" href="https://instagram.com/cittakshashila?igshid=YmMyMTA2M2Y=">
              <FaInstagram size={25} />
            </a>
            <a className="m-2 text-white" href="https://wa.me/message/6HAFB72GRMU7N1">
              <FaWhatsapp size={25} />
            </a>
            <a className="m-2 text-white" href="https://youtube.com/c/CITTakshashila">
              <FaYoutube size={25} />
            </a>
          </div>
        </div>
